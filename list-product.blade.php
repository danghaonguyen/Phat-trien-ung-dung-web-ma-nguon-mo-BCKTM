...
<div class="container-fluid px-4">
    ...
    <form action="{{ route('admin.list-product') }}" method="GET" class="mb-4">
      ...
      <!--               <input type="text" name="name" class="form-control" placeholder="Nhập tên sản phẩm..." value="{{ old('name', $brandName ?? '') }}" autocomplete="off"> -->

                    <input type="text" name="keyword" class="form-control" placeholder="Nhập tên sản phẩm..." value="{{ old('keyword', $keyword ?? '') }}" autocomplete="off">
