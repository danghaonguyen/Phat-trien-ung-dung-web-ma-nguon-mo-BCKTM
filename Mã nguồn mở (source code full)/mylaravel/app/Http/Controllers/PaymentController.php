...
class PaymentController extends Controller
{
    ...
    public function createPayment(Request $request, $product_id)
    {
        ...
        $user = User::findOrFail($userId); // // Gọi bảng user để lấy thông tin của người dùng
        $userPhone = $user->phone; // lấy trường phone (số điện thoại) từ bảng user

        // Tính số tiền đặt cọc (5% giá sản phẩm)
        $depositAmount = $product->price * 0.05;
