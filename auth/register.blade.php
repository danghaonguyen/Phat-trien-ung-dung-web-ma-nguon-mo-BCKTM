    ...
    <div class="register-container" style=" background-image: url('img/dark-red.jpg'); background-size: cover; background-position: center;
        ...
        <form method="POST" action="{{ route('register') }}" class="register-form">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control icon-input" id="address" name="address" required placeholder="VD: 123 Đường ABC, Quận XYZ">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control icon-input" id="phone" name="phone" required placeholder="VD: 0987654321">
            </div>
