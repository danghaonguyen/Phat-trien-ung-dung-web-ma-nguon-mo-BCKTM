...
@section('content')
<!-- Header--> <!-- Xử lý sildeshow -->
<header>
    <div class="header-image">
        <img src="{{ asset('img/banner/banner-honda.png') }}" alt="Hình ảnh tiêu đề" class="img-fluid" width="1500" height="400">
    </div>
</header>
<!-- Section-->
<section class="py-5">
    <h2 class="text-center mb-4">CÁC DÒNG XE HONDA</h2>
